...
export default function MainPage() {
  const [showAccordion, setShowAcoordian] = useState(null);
      ...
      <Container>
        ...
        >
          ...
          <div className={styleAccordionBody("ROBOCUP")}>
            ...
            로봇분야-전자, 하드웨어, 소프트웨어 등-에 대한 기술능력을 직접 키울
            수 있는 기회를 제공합니다. 아울러 친구들과 함께 기술을 공유하면서
            팀워크에 대해 배울 수 있는 동기부여를 받고 특별한 경험을 할 수 있는
            새로운 방법을 제시합니다. 로보컵 리그는 다양한 참가자들이 우수한
            로봇개발이라는 공동의 목표를 달성할 수 있는 팀으로 함께 연구할 수
            있는 기회를 제공합니다.
          </div>
        </div>
      </Container>
